...
Tags: survey, quiz, poll, questionnaire, customer satisfaction, best, survey form, wordpress, wordpress survey plugin
...
[PRO version: Modal Survey PRO - WordPress Survey Plugin](https://modalsurvey.com)
...
= 1.7 =
* added translation option to some remained fixed strings

= 1.6.1 =
* fixed cookie notice issue

= 1.6 =
* fixed shortcode survey ID issue on admin

= 1.5.9 =
* added localization strings, minor code improvements
